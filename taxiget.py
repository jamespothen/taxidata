...
print('vendorid, tpep_pickup_datetime, dropoff_datetime, passenger_count, trip_distance, pickup_longitude, pickup_latitude, ratecodeid, store_and_fwd_flag, dropoff_longitude, dropoff_latitude, payment_type, fare_amount, extra, mta_tax, tip_amount, tolls_amount, total_amount', file=outfile)

for ride in ridelist:
    for header in headers:
        if header == 'store_and_fwd_flag' or header == 'pickup_location' or header == 'dropoff_location':
            continue
